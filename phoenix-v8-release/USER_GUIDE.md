...
本文件是**桌上速查**。**操作细节与场景说明**见同目录 **[不死鸟_Phoenix_V8_使用说明书.md](./不死鸟_Phoenix_V8_使用说明书.md)**；**请求路径、记忆与自愈原理**见 **[不死鸟_Phoenix_V8_技术细则与路径原理.md](./不死鸟_Phoenix_V8_技术细则与路径原理.md)**；安装与交付口径仍以 **[START_HERE.md](./START_HERE.md)** 索引为准。
