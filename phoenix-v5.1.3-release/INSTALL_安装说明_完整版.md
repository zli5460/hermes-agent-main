...
### 1.1 以前装过 5.0 / 5.1 / 4.8 等，怎么「覆盖」成 V5.1.3？
...
2. **再安装**：把 V5.1.3 的文件写入 **`~/.hermes/phoenix`**，并对 **`phoenix_full` 插件目录做强制同步覆盖**（bundled + 用户插件双路径，与旧版插件一致替换）。
...
| [PHOENIX_5.1.3_CORE_DELIVERY.md](./PHOENIX_5.1.3_CORE_DELIVERY.md) | 交付口径 |
| [HERMES_融合与随版本升级.md](./HERMES_融合与随版本升级.md) | Hermes 升级后融合、`auto_fusion`、hooks |

---

*Phoenix V5.1.3 · 与 `install.sh` / `install.ps1` 行为对齐 · 修订请随版本更新*
