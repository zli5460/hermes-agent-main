...
class RouteDecision:
    ...
    base_url: Optional[str] = None         # V5.1: ProviderResolver解析出的端点
    api_key_env: Optional[str] = None      # V5.1: 环境变量名（不保存真实Key）
    provider_binding: Optional[dict] = None # V5.1: 脱敏Provider绑定审计信息
