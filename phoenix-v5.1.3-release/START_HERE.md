# Phoenix V5.1.3 初心回归版

定位：手动升档 + 自动托底 + 自动安装验收。

**核心交付总览（给老板/客户对口径）**：见同目录 **[PHOENIX_5.1.3_CORE_DELIVERY.md](./PHOENIX_5.1.3_CORE_DELIVERY.md)**（含 V5.1.3 变更点、安装与模型「写死」争议、验收话术）。

**完整架构蓝图（与 FreeRoute 蓝图同级篇幅）**：[Phoenix_V5.1.3_初心回归_架构蓝图.md](./Phoenix_V5.1.3_初心回归_架构蓝图.md) — 手动挡 vs 自动路由、自愈/记忆、hermes 入口铁律、路线图。
...
**⭐ 使用说明书（操作细节、每一步该怎么理解）**：[不死鸟_Phoenix_V5.1.3_使用说明书.md](./不死鸟_Phoenix_V5.1.3_使用说明书.md)

**⭐ 技术细则（路径怎么走、记忆原理、模块如何串联）**：[不死鸟_Phoenix_V5.1.3_技术细则与路径原理.md](./不死鸟_Phoenix_V5.1.3_技术细则与路径原理.md)
